  ...
  return (
    <section className="py-16 bg-gradient-to-b from-background to-muted/20">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-3 animate-in fade-in slide-in-from-bottom-4 duration-700">
          Типы камер видеонаблюдения
        </h2>
        <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-700 delay-150">
        ...
        <div className="grid sm:grid-cols-1 lg:grid-cols-2 gap-6 max-w-6xl mx-auto">
          {cameraTypes.map((camera, index) => (
            ...
            >
              <Link to={camera.link} className="group block h-full">
