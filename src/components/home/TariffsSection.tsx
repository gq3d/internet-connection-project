...
const tariffs = [
  ...
  },
  {
    ...
    features: ['Безлимитный трафик', 'Wi-Fi роутер 802.11ac', 'Приоритетная поддержка']
  },
  {
    name: 'Премиум',
    speed: '240 Мбит/с',
    ...
    features: ['Безлимитный трафик', 'Профессиональное оборудование', 'VIP поддержка', 'Резервный канал']
  }
];
