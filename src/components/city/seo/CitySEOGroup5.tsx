...
export const getCitySEOGroup5 = (cityName: string): CitySEOContent | null => {
  ...
  const cityTemplates: Record<string, { district: string; villages: string[]; cottages: string[] }> = {
    'Одинцово': {
      ...
      villages: [
        'Барвиха', 'Жуковка', 'Ромашково', 'Горки-2', 'Горки-10', 'Раздоры', 'Николина Гора', 'Лесной Городок',
        'Успенское', 'Заречье', 'Власиха', 'Перхушково', 'Немчиновка', 'Акулово', 'Дубки',
        'Сколково', 'Зайцево', 'Каринское', 'Назарьево', 'Ликова', 'Поляны', 'Покровское',
        'Дунино', 'Усово', 'Солослово', 'Грязь', 'Мамоново', 'Хлюпино', 'Лайково'
      ],
      cottages: [
        'Горки XXI', 'Николино', 'Трувиль', 'Ромашково XXI', 'Березки', 'Жуковка XXI',
        'Бавария', 'Павлово', 'Резиденция Рублево', 'Новахово', 'Успенка', 'Лесные Дали',
        'Княжье Озеро', 'Немчиновка парк', 'Ильинские дачи', 'Петрово-Дальнее', 'Подушкино',
        'Сосны', 'Лесная усадьба', 'Усово Village', 'Екатерининский', 'Охта Парк', 'Барвиха Club'
      ]
    },
    'Раменское': {
      district: 'Раменский городской округ',
      villages: [
        'Быково', 'Кратово', 'Удельная', 'Ильинский', 'Родники', 'Верея', 'Жуковский',
        'Михайловская Слобода', 'Чулково', 'Новохаритоново', 'Дергаево', 'Заворово', 'Игумново',
        'Константиново', 'Клишева', 'Малахово', 'Новое', 'Островцы', 'Рыболово', 'Софьино',
        'Хрипань', 'Чулково-Соколово', 'Электроизолятор', 'Фенино', 'Вялки'
      ],
      cottages: [
        'Быково парк', 'Кратово парк', 'Родники парк', 'Верея парк', 'Чулково парк',
        'Ильинские дачи', 'Малахово парк', 'Софьино парк', 'Удельная парк', 'Новое парк',
        'Раменское хилс', 'Островцы парк', 'Фенино парк', 'Константиново парк', 'Лесная поляна',
        'Зелёный бор', 'Раменский лес', 'Быковские дачи', 'Загорье'
      ]
    },
    'Долгопрудный': {
      district: 'Городской округ Долгопрудный',
      villages: [
        'Водники', 'Павельцево', 'Хлебниково', 'Шереметьево', 'Новое', 'Котово',
        'Виноградово', 'Лихачёво', 'Московское море', 'Шереметьевский', 'Мысово',
        'Ново-Архангельское', 'Марфино', 'Грибки', 'Хлебниково-1', 'Хлебниково-2'
      ],
      cottages: [
        'Водники парк', 'Павельцево парк', 'Котово парк', 'Новое парк', 'Лесной',
        'Виноградово парк', 'Шереметьево парк', 'Долгопрудный хилс', 'Марфино парк',
        'Хлебниково парк', 'Мысово парк', 'Лихачёво парк', 'Грибки парк', 'Подмосковные дачи',
        'Канал имени Москвы', 'Зелёная гавань', 'Московское море'
      ]
    },
    'Воскресенск': {
