...
export const getCitySEOGroup5 = (cityName: string): CitySEOContent | null => {
  ...
  const cityTemplates: Record<string, { district: string; villages: string[]; cottages: string[] }> = {
    ...
    'Воскресенск': {
      ...
      villages: [
        'Ашитково', 'Виноградово', 'Горы', 'Золотово', 'Конобеево', 'Маришкино', 'Белозерский',
        'Хорлово', 'Фаустово', 'Цюрупы', 'Степановка', 'Новлянское', 'Пестово', 'Троицкое',
        'Авдотьино', 'Барановичи', 'Васильевское', 'Егорьевское', 'Кривандино', 'Лопатинский',
        'Нестерово', 'Орешково', 'Полянки', 'Юрасово', 'Кузьминка', 'Москворечье'
      ],
      cottages: [
        'Ашитково парк', 'Виноградово парк', 'Золотово парк', 'Конобеево парк', 'Маришкино парк',
        'Белозерский парк', 'Хорлово парк', 'Фаустово парк', 'Воскресенские дачи', 'Москворечье парк',
        'Пестово парк', 'Троицкое парк', 'Лесная поляна', 'Зелёный бор', 'Речные дали',
        'Васильевское парк', 'Егорьевское парк', 'Юрасово парк', 'Кузьминка парк'
      ]
    },
    'Ивантеевка': {
      district: 'Городской округ Ивантеевка',
      villages: [
        'Вантеево', 'Копнино', 'Башмаково', 'Детская', 'Заря', 'Луговая',
        'Смена', 'Феклино', 'Хлебниково', 'Юркино'
      ],
      cottages: [
        'Ивантеевка парк', 'Вантеево парк', 'Копнино парк', 'Башмаково парк',
        'Феклино парк', 'Юркино парк', 'Лесные дали', 'Зелёная роща'
      ]
    },
    'Павловский Посад': {
      district: 'Павлово-Посадский городской округ',
      villages: [
        'Аверкиево', 'Большие Дворы', 'Васютино', 'Городищи', 'Демихово', 'Евсеево',
        'Заозерье', 'Кузнецы', 'Леоново', 'Меленки', 'Ногино', 'Рахманово',
        'Улиткино', 'Фрязино', 'Филимоново', 'Часовня'
      ],
      cottages: [
        'Павловский Посад парк', 'Аверкиево парк', 'Демихово парк', 'Городищи парк', 'Евсеево парк', 'Васютино парк',
        'Заозерье парк', 'Кузнецы парк', 'Леоново парк', 'Рахманово парк', 'Фрязино парк',
        'Лесная поляна', 'Зелёный бор', 'Речные дали'
      ]
    },
    'Наро-Фоминск': {
      district: 'Наро-Фоминский городской округ',
      villages: [
        'Афинеево', 'Атепцево', 'Бекасово', 'Васильевское', 'Верея', 'Головково',
        'Апрелевка', 'Каменское', 'Крёкшино', 'Латышская', 'Малое Карлино', 'Мартемьяново',
        'Селятино', 'Калининец', 'Новая Ольховка', 'Ташировка'
      ],
      cottages: [
        'Наро-Фоминск парк', 'Афинеево парк', 'Атепцево парк', 'Бекасово парк', 'Верея парк', 'Головково парк',
        'Апрелевка парк', 'Каменское парк', 'Крёкшино парк', 'Селятино парк', 'Калининец парк',
        'Лесная усадьба', 'Зелёные холмы', 'Речная долина'
      ]
    },
    'Можайск': {
      district: 'Можайский городской округ',
      villages: [
        'Бородино', 'Горетово', 'Дровнино', 'Ельня', 'Клементьево', 'Колоцкое',
        'Борисово', 'Ватулино', 'Грибово', 'Дмитровка', 'Красный Балтиец', 'Мокрое',
        'Поречье', 'Хотилово', 'Шапкино', 'Юрлово'
      ],
      cottages: [
        'Можайск парк', 'Бородино парк', 'Горетово парк', 'Дровнино парк', 'Ельня парк', 'Клементьево парк',
        'Борисово парк', 'Ватулино парк', 'Грибово парк', 'Красный Балтиец парк',
        'Можайское море', 'Лесные дали', 'Поречье парк'
      ]
    },
    'Ступино': {
      district: 'Ступинский городской округ',
      villages: [
        'Аксиньино', 'Барабаново', 'Верзилово', 'Городище', 'Жилёво', 'Семёновское',
        'Алфёрово', 'Большое Алексеевское', 'Воскресенки', 'Дубневское', 'Каменка', 'Кременье',
        'Малино', 'Сайгатово', 'Старая Ситня', 'Хатунь'
      ],
      cottages: [
        'Ступино парк', 'Аксиньино парк', 'Барабаново парк', 'Верзилово парк', 'Городище парк', 'Семёновское парк',
        'Алфёрово парк', 'Воскресенки парк', 'Каменка парк', 'Малино парк', 'Хатунь парк',
        'Лесная поляна', 'Зелёный бор', 'Речные дали'
      ]
    },
    'Протвино': {
      ...
      villages: [
        'Данки', 'Спас-Темня', 'Боровково', 'Высоково', 'Заболотье',
        'Кременье', 'Новое', 'Юрятино'
      ],
      cottages: [
        'Протвино парк', 'Данки парк', 'Спас-Темня парк', 'Боровково парк',
        'Высоково парк', 'Юрятино парк', 'Лесные дали'
      ]
    },
    'Лосино-Петровский': {
