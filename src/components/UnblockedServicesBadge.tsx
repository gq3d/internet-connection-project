    ...
    <div className="inline-flex items-center gap-3 bg-gradient-to-r from-green-500/10 via-blue-500/10 to-purple-500/10 border-2 border-green-500/30 rounded-2xl px-6 py-4 shadow-lg hover:shadow-xl transition-all">
      <div className="flex items-center gap-2">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="w-8 h-8 bg-gradient-to-tr from-purple-600 via-pink-600 to-orange-500 rounded-lg flex items-center justify-center shadow-sm" title="Instagram">
          ...
          <div className="w-8 h-8 bg-blue-600 rounded-lg flex items-center justify-center shadow-sm" title="Facebook">
            <svg className="w-5 h-5" viewBox="0 0 24 24" fill="white">
