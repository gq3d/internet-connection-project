      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden lg:flex items-center gap-3 xl:gap-4">
            ...
            <a href="/#about" className="text-sm font-medium hover:text-success transition-colors whitespace-nowrap">О компании</a>
            <a href="/faq" className="text-sm font-medium hover:text-success transition-colors whitespace-nowrap">FAQ</a>
            <a href="/#contacts" className="text-sm font-medium hover:text-success transition-colors whitespace-nowrap">Контакты</a>
            <a 
