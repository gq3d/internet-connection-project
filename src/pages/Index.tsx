          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mt-20">
              <div className="text-center mb-12">
                <div className="inline-block bg-gradient-to-r from-primary to-success text-white px-6 py-2 rounded-full mb-4">
                  <span className="font-semibold">🛠️ Профессиональное оборудование</span>
                </div>
              ...
              <div className="mb-16">
                <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-t-xl p-6">
                  <div className="flex items-center justify-center">
                    <Icon name="Antenna" size={32} className="mr-4" />
                    <h4 className="text-2xl font-bold">Антенны MIMO для LTE/4G</h4>
                  </div>
                  <p className="text-center mt-2 text-blue-100">Направленные и всенаправленные антенны для максимального качества сигнала</p>
                </div>
                <div className="grid md:grid-cols-3 gap-6 bg-card border border-t-0 rounded-b-xl p-8">
                  <div className="group hover:scale-105 transition-transform duration-300">
                    <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-6 h-full border-2 border-blue-200 hover:border-blue-400 transition-colors">
                      ...
                      <h5 className="font-bold text-lg mb-2 text-blue-900">MIMO Панельная антенна</h5>
                      <p className="text-sm text-blue-700 mb-3">Двухполяризационная антенна с усилением 2x18 dBi</p>
                  ...
                  <div className="group hover:scale-105 transition-transform duration-300">
                    <div className="bg-gradient-to-br from-indigo-50 to-indigo-100 rounded-xl p-6 h-full border-2 border-indigo-200 hover:border-indigo-400 transition-colors">
                      ...
                      <h5 className="font-bold text-lg mb-2 text-indigo-900">MIMO Направленная</h5>
                      <p className="text-sm text-indigo-700 mb-3">Узконаправленная антенна высокого усиления</p>
                      <div className="space-y-2 text-sm">
                  ...
                  <div className="group hover:scale-105 transition-transform duration-300">
                    <div className="bg-gradient-to-br from-cyan-50 to-cyan-100 rounded-xl p-6 h-full border-2 border-cyan-200 hover:border-cyan-400 transition-colors">
                      ...
                      <h5 className="font-bold text-lg mb-2 text-cyan-900">Ubiquiti LTE Antenna</h5>
                      <p className="text-sm text-cyan-700 mb-3">Всепогодная антенна для уличной установки</p>
                      <div className="space-y-2 text-sm">
              ...
              {/* LTE Routers */}
              <div className="mb-16">
                <div className="bg-gradient-to-r from-green-600 to-emerald-700 text-white rounded-t-xl p-6">
                  <div className="flex items-center justify-center">
                    <Icon name="Router" size={32} className="mr-4" />
                    <h4 className="text-2xl font-bold">LTE/4G роутеры и модемы</h4>
                  </div>
                  <p className="text-center mt-2 text-green-100">Профессиональное оборудование для преобразования сигнала в Wi-Fi</p>
                </div>
                <div className="grid md:grid-cols-3 gap-6 bg-card border border-t-0 rounded-b-xl p-8">
                  <div className="group hover:scale-105 transition-transform duration-300">
                    <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-6 h-full border-2 border-green-200 hover:border-green-400 transition-colors">
                      ...
                      <h5 className="font-bold text-lg mb-2 text-green-900">ZyXel LTE3301-PLUS</h5>
                      <p className="text-sm text-green-700 mb-3">Профессиональный LTE роутер с поддержкой Cat.4</p>
                      <div className="space-y-2 text-sm">
                  ...
                  <div className="group hover:scale-105 transition-transform duration-300">
                    <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-6 h-full border-2 border-blue-200 hover:border-blue-400 transition-colors">
                      ...
                      <h5 className="font-bold text-lg mb-2 text-blue-900">TP-Link Archer MR600</h5>
                      <p className="text-sm text-blue-700 mb-3">Двухдиапазонный 4G+ роутер Cat.6</p>
                      <div className="space-y-2 text-sm">
                        <div className="flex items-center text-blue-600">
                          <Icon name="Zap" size={16} className="mr-2 text-amber-600" />
                  ...
                  <div className="group hover:scale-105 transition-transform duration-300">
                    <div className="bg-gradient-to-br from-red-50 to-red-100 rounded-xl p-6 h-full border-2 border-red-200 hover:border-red-400 transition-colors">
                      ...
                      <h5 className="font-bold text-lg mb-2 text-red-900">Huawei B535-232</h5>
                      <p className="text-sm text-red-700 mb-3">Флагманский LTE CPE роутер Cat.7</p>
                      <div className="space-y-2 text-sm">
              ...
              <div className="bg-gradient-to-br from-amber-50 to-orange-50 border-2 border-amber-200 rounded-2xl p-8">
                <div className="text-center mb-8">
                  ...
                  <h4 className="text-2xl font-bold text-amber-900 mb-3">Почему важно профессиональное оборудование?</h4>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h5 className="font-bold text-lg mb-2 text-amber-900">Стабильная скорость</h5>
                      <p className="text-amber-800">Профессиональные роутеры обеспечивают заявленную скорость даже при большой нагрузке на сеть</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h5 className="font-bold text-lg mb-2 text-amber-900">Надежность</h5>
                      <p className="text-amber-800">Оборудование работает без перезагрузок 24/7, выдерживает перепады температур и влажности</p>
                    </div>
                  </div>
                  
                  <div className="flex items-start space-x-4">
                    <div className="flex-shrink-0 w-10 h-10 bg-purple-500 rounded-full flex items-center justify-center">
                      <Icon name="Signal" size={20} className="text-white" />
                    </div>
                    <div>
                      <h5 className="font-bold text-lg mb-2 text-amber-900">Максимальное покрытие</h5>
                      <p className="text-amber-800">MIMO антенны ловят сигнал даже в сложных условиях на расстоянии до 25 км от вышки</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h5 className="font-bold text-lg mb-2 text-amber-900">Долгий срок службы</h5>
                      <p className="text-amber-800">Гарантия производителя до 3 лет, реальный срок работы 5-7 лет без замены</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {/* Call to Action */}
              <div className="mt-12 bg-gradient-to-r from-primary via-success to-secondary text-white rounded-2xl p-10 text-center shadow-2xl">
                <Icon name="Phone" size={48} className="mx-auto mb-4" />
                <h4 className="text-3xl font-bold mb-4">Подберём оптимальное оборудование для вашего объекта</h4>
                <p className="text-xl mb-6 opacity-90">Наши специалисты проведут замеры сигнала и предложат лучшее решение</p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                  <a 
                    href="tel:+79015000078"
                    className="inline-flex items-center px-8 py-4 bg-white text-primary rounded-full font-bold text-lg hover:bg-gray-100 transition-colors shadow-lg"
                  >
                  ...
                  <a 
                    ...
                    className="inline-flex items-center px-8 py-4 bg-green-500 text-white rounded-full font-bold text-lg hover:bg-green-600 transition-colors shadow-lg"
                  >
