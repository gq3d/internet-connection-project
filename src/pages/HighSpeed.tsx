...
const HighSpeed = () => {
  ...
  useSEO({
    title: 'Высокоскоростной интернет до 250 Мбит/с в МО | Bonding до 1 Гбит/с | NetConnect',
    description: 'Беспроводной интернет до 250 Мбит/с для дома. Bonding - объединение каналов до 1 Гбит/с для бизнеса. Стриминг 4K, онлайн-игры, видеозвонки без задержек. Звоните: +7 (901) 500-00-78',
    canonical: 'https://mosoblconnect.ru/high-speed',
    keywords: 'высокоскоростной интернет мо, быстрый интернет подмосковье, интернет 250 мбит, bonding каналов, объединение интернет каналов, сумматор интернет, интернет 1 гбит для бизнеса, агрегация каналов связи',
    ogTitle: 'Высокоскоростной интернет 250 Мбит/с | Bonding до 1 Гбит/с в МО',
    ogDescription: 'Беспроводной интернет до 250 Мбит/с. Bonding - объединение каналов до 1 Гбит/с для бизнеса. Без проводов, быстрое подключение.',
