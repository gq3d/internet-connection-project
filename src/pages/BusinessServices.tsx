...
const BusinessServices = () => {
  useSEO({
    title: 'Корпоративные IT-решения для бизнеса в МО | Интернет, Wi-Fi, Видеонаблюдение | NetConnect',
    description: 'Профессиональные телекоммуникационные услуги для бизнеса в Подмосковье: выделенный интернет до 1 Гбит/с с SLA 99.9%, корпоративный Wi-Fi, IP-видеонаблюдение 4K, охранные системы. Работаем по договору с юрлицами. Персональный менеджер и техподдержка 24/7. ☎️ +7 (901) 500-00-78',
    keywords: 'интернет для бизнеса московская область, корпоративный интернет мо, выделенная линия интернет, wifi для офиса подмосковье, видеонаблюдение для бизнеса, системы безопасности офис, скуд установка, интернет для юридических лиц, it решения для бизнеса',
    ogTitle: 'Корпоративные IT-решения для бизнеса | NetConnect',
    ogDescription: 'Интернет до 1 Гбит/с, Wi-Fi, видеонаблюдение, охрана для офисов и производств в МО. SLA 99.9%, работа по договору, поддержка 24/7.',
