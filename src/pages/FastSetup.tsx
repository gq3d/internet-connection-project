                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        Позвоните нам по телефону +7 (901) 500-00-78 или оставьте заявку на сайте. Наш специалист свяжется 
                        с вами в течение 30 минут, уточнит адрес и проверит возможность подключения. Расскажет о доступных 
                ...
                <CardContent className="p-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        На следующий день после заявки курьер привезёт всё необходимое оборудование: внешнюю антенну, 
                        Wi-Fi роутер, блоки питания, крепёж и кабели. Вам не нужно ничего покупать дополнительно. 
                        Оборудование предоставляется в аренду на весь период обслуживания, либо можно выкупить по 
                ...
                <CardContent className="p-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        В согласованное время приезжает бригада из двух монтажников со всем инструментом. Установка занимает 
                        2-3 часа: крепление внешней антенны на фасад или крышу дома, прокладка кабеля внутрь помещения, 
                        установка и подключение роутера. Работы выполняются аккуратно, без повреждения отделки. Весь мусор 
                        убирается, крепёжные отверстия герметизируются.
                      </p>
                    </div>
                  </div>
                </CardContent>
