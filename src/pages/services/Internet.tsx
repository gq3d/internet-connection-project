...
const Internet = () => {
  useSEO({
    title: 'Беспроводной интернет в МО от 1490₽ | Bonding до 1 Гбит/с | NetConnect',
    description: 'Подключение беспроводного интернета для дома и дачи в МО. Скорость до 250 Мбит/с, тарифы от 1490₽. Bonding - объединение каналов до 1 Гбит/с для бизнеса. Установка за 1-3 дня без закапывания кабеля.',
    keywords: 'беспроводной интернет, интернет московская область, радиоканал интернет, подключить интернет мо, провайдер подмосковье, интернет без проводов, быстрый интернет, bonding каналов, объединение интернет каналов, сумматор каналов связи, интернет 1 гбит',
    canonical: 'https://mosoblconnect.ru/services/internet',
    ogTitle: 'Беспроводной интернет в МО от 1490₽ | Bonding до 1 Гбит/с',
    ogDescription: 'Быстрое подключение беспроводного интернета до 250 Мбит/с. Bonding до 1 Гбит/с для бизнеса. Тарифы от 1490₽/мес.',
