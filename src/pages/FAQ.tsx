...
const faqs = [
  ...
  },
  {
    ...
    answer: 'Базовый комплекс включает: монтаж антенны на фасаде или крыше, прокладку кабелей до 20 метров, установку и настройку роутера, подключение и тестирование. Конечная стоимость складывается из цены оборудования и стоимости работ. Дополнительные работы (прокладка кабелей свыше 20 метров, сложный монтаж, дополнительные точки доступа) оговариваются отдельно при составлении и согласовании окончательной сметы после выезда специалиста на объект.'
  },
  {
